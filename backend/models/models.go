...
type Petugas struct {
	...
	NamaPetugas string     `gorm:"column:nama_petugas" json:"nama_petugas"`
	Username    string     `gorm:"column:username" json:"username"`
	Password    string     `gorm:"column:password" json:"-"`
	Telp        string     `gorm:"column:telp" json:"telp"`
...
type Pengaduan struct {
	...
	JudulLaporan   string      `gorm:"column:judul_laporan" json:"judul_laporan"`
	IsiLaporan     string      `gorm:"column:isi_laporan" json:"isi_laporan"`
	TglKejadian    time.Time   `gorm:"column:tgl_kejadian" json:"tgl_kejadian"`
	LokasiKejadian string      `gorm:"column:lokasi_kejadian" json:"lokasi_kejadian"`
...
type Tanggapan struct {
	...
	IDPengaduan   uint64     `gorm:"column:id_pengaduan" json:"id_pengaduan"`
...
type Permohonan struct {
	...
	NIK            string        `gorm:"column:nik" json:"nik"`
	IDJenisLayanan uint64        `gorm:"column:id_jenis_layanan" json:"id_jenis_layanan"`
	...
	Status         string        `gorm:"column:status" json:"status"`
	CatatanPetugas string        `gorm:"column:catatan_petugas" json:"catatan_petugas"`
	...
	UpdatedAt      *time.Time    `gorm:"column:updated_at" json:"updated_at,omitempty"`
	Masyarakat     *Masyarakat   `gorm:"foreignKey:NIK;references:NIK" json:"masyarakat,omitempty"`
	JenisLayanan   *JenisLayanan `gorm:"foreignKey:IDJenisLayanan" json:"jenis_layanan,omitempty"`
	Petugas        *Petugas      `gorm:"foreignKey:IDPetugas" json:"petugas,omitempty"`
}
...
type JenisLayanan struct {
	...
	Syarat       string     `gorm:"column:syarat" json:"syarat"`
